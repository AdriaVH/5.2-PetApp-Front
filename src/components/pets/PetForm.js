...
// Define allowed pet types matching the backend enum
const PET_TYPES = [
  "DOG",
  "CAT",
  "FERRET",
...
const PetForm = ({ petToEdit, onSave }) => {
  ...
  useEffect(() => {
    if (petToEdit) {
      ...
      setType(petToEdit.type); // should now match enum string
  ...
  return (
    <div className="flex justify-center">
      <form
        ...
        className="w-1/3 bg-white px-4 py-5 rounded-md  shadow-2xl shadow-black"
      >
